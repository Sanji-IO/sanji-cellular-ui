...
import { CellularActions, cellulars, carrier, GET_CELLULARS, UPDATE_CELLULAR } from './component.state';
import CellularService from './component.service';
import CellularWindowComponent from './window.component';

const sjCellular = angular
  .module('sanji.cellular', [sjCellularInfo, sjCellularForm])
  .config(i18nConfig)
  .factory('cellularActions', CellularActions)
  .service('cellularService', CellularService)
  .component('sanjiCellularWindow', CellularWindowComponent).name;
